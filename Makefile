...
setup:
	@if [ ! -f ./fabrydb/conf/local_settings.py ] && [ -f ./fabrydb/conf/local_settings.py.sample ]; then \
	    echo 'Creating local_settings.py...'; \
	    cp ./fabrydb/conf/local_settings.py.sample ./fabrydb/conf/local_settings.py; \
	fi;
